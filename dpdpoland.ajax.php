...
if (Tools::isSubmit('savePackagePrintLabels'))
{
    ...
    die(Tools::jsonEncode(array(
        ...
        'link_to_labels_pdf'  => '?printLabels&id_package='.(int)$id_package.'&printout_format='.Tools::getValue(DpdPolandConfiguration::PRINTOUT_FORMAT).'&token='.Tools::getValue('token')
    )));
}
...
if (Tools::isSubmit('printLabels'))
{
    die(Tools::jsonEncode(array(
        'error' => false,
        'link_to_labels_pdf'  => '?printLabels&id_package='.(int)Tools::getValue('id_package').'&printout_format='.Tools::getValue('printout_format').'&token='.Tools::getValue('token')
    )));
}
